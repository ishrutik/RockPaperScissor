...
import('../congratulations_page/congrats.html')
...
function add_ripple_effect_user_wins(){
  ...
  ripple.innerHTML = `
  <img src="../images/Ellipse 3.png" alt="" class="i3">
  <img src="../images/Ellipse 5.png" alt="" class="i1">
  <img src="../images/Ellipse 4.png" alt="" class="i2">
  `;
...
function add_specs(wins){
  ...
  if (wins === 1){ 
    ...
    next_btn.innerHTML = `
    <a href="congratulations_page/congrats.html" style="text-decoration: none; color: white;">
...
stone.addEventListener("click",()=>{
  ...
  computer_answer.innerHTML = `<img src="../images/${image}.png" alt="" class="cs-scissor-icon">`;
